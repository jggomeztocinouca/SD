...
def add_miembro():
    ...
    if 'asignaturas' in nuevo_miembro and nuevo_miembro['categoria'] != 'PDI':  # Si se incluyeron asignaturas y la
        # categoría no es PDI
        return HTTPResponse(status=400,
                            body='Solo los miembros PDI pueden tener asignaturas')  # Devolvemos un error 400
...
def modificar_miembro(dni):  # Recibimos el DNI como parámetro en la URL
    ...
    # Para cada uno de los atributos que podemos modificar, comprobamos si se incluyeron en los nuevos datos y en
    # caso afirmativo los actualizamos
...
def delete_miembro(dni):  # Recibimos el DNI como parámetro en la URL
    ...
    return HTTPResponse(status=200,
                        body='Miembro eliminado')  # Devolvemos una respuesta con estado 200 y un mensaje indicando
    # que el miembro fue eliminado
